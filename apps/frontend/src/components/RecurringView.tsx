...
export const RecurringView = () => {
  ...
  const [newScheduleType, setNewScheduleType] =
    useState<RecurringScheduleType>("DAILY");
  ...
  return (
    <>
      <div className="flex-1 overflow-y-auto custom-scrollbar p-6 md:p-10 max-w-4xl mx-auto w-full">
        ...
        {isCreating && (
          <div className="mb-6 p-6 border border-black/[0.05] dark:border-white/[0.05] bg-[var(--accent-500)]/[0.03] rounded animate-fadeIn">
            <h3 className="text-[10px] uppercase tracking-[0.2em] font-bold text-[var(--accent-600)] dark:text-[var(--accent-400)] mb-4">
              New Scheduled Mission
            </h3>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
              ...
              <div className="md:col-span-3 space-y-1">
                <label className="text-[8px] uppercase font-bold text-slate-400 dark:text-slate-500">
                  ...
                  <span className="text-slate-300 dark:text-slate-700 normal-case">
              ...
              <div className="space-y-1">
                ...
                <Select
                  ...
                  onValueChange={(v) =>
                    setNewScheduleType(v as RecurringScheduleType)
                  }
                ...
                <input
                  ...
                  placeholder={
                    newScheduleType === "CUSTOM"
                      ? "*/15 * * * *  (required)"
                      : "Not needed for preset schedules"
                  }
              ...
              return (
                ...
                >
                  {isEditing ? (
                    /* ── Inline edit form ── */
                    <div className="space-y-3">
                      <h3 className="text-[9px] uppercase tracking-[0.2em] font-bold text-[var(--accent-500)] mb-2">
                        Edit Scheduled Mission
                      </h3>
                      <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
                        ...
                        <div className="space-y-1">
                          ...
                          <Select
                            ...
                            onValueChange={(v) =>
                              setEditScheduleType(v as RecurringScheduleType)
                            }
                            options={SCHEDULE_TYPE_OPTIONS}
                            placeholder="— Schedule Type —"
                          />
                        ...
                        <div className="md:col-span-2 space-y-1">
                          ...
                          <input
                            ...
                            onChange={(e) =>
                              setEditScheduleValue(e.target.value)
                            }
                            placeholder={
                    ...
                    <div className="flex items-center gap-4">
                      <div className="flex-1 min-w-0">
                        <div className="flex items-center gap-2 mb-1">
                          ...
                          <Badge
                            variant={
                              task.status === "ACTIVE" ? "success" : "default"
                            }
                          >
                            {task.status}
                          </Badge>
                        ...
                        {task.description && (
                          <p className="text-[10px] text-slate-500 dark:text-slate-400 mb-1 line-clamp-2">
                            {task.description}
                          </p>
                        )}

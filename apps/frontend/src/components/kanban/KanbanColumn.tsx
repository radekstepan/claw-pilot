...
export const KanbanColumn = ({ title, tasks, onTaskClick }: KanbanColumnProps) => (
    <div className="flex-1 min-w-[280px] flex flex-col h-full border-r border-black/[0.04] dark:border-white/[0.04] last:border-r-0">
        ...
        <div className="flex-1 p-3 overflow-y-auto custom-scrollbar bg-transparent">
            ...
            {tasks.length === 0 && (
                <div className="h-full flex flex-col items-center justify-center opacity-40 dark:opacity-20 border border-dashed border-slate-200 dark:border-white/10 rounded p-8">

...
export const Sidebar = ({ onOpenSettings, isMobileOpen, onMobileClose, activeView, onChangeView }: SidebarProps) => {
    return (
        <aside
            ...
            bg-[#f8fafc] dark:bg-[var(--bg-dark-base)] flex flex-col overflow-hidden
            ...
            <div className="p-4 border-b border-black/[0.04] dark:border-white/[0.04]">
                ...
                <nav className="space-y-1" aria-label="Views">
                    <button
                        ...
                        className={`w-full flex items-center gap-2.5 p-2.5 rounded-sm transition-all text-[11px] font-bold focus-visible:outline-none ${activeView === 'kanban'
                    ...
                    <button
                        ...
                        className={`w-full flex items-center gap-2.5 p-2.5 rounded-sm transition-all text-[11px] font-bold focus-visible:outline-none ${activeView === 'recurring'
                                ? 'accent-active-bg border text-[var(--accent-600)] dark:text-[var(--accent-300)]'
                                : 'hover:bg-black/[0.02] dark:hover:bg-white/[0.03] border border-transparent text-slate-600 dark:text-slate-400'
                            }`}
                    >
